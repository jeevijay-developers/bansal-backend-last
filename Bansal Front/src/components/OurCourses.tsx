...
const OurCourses = ({ coursesFilter }: any) => {
  ...
  return (
    <section className="overflow-hidden">
      <div className="course-listing-section">
        <div className="container">
          <h2 className="heading mb-4">
            Explore All Our <span className="course-heading-span">Courses</span>
          </h2>
            ...
            {activeCategory && (
              <div className="course-listing-slider">
                <Slider {...CourseSettings}>
                  {activeCategory.courses.map((course: any, index: number) => (
                    <div className="item" key={index}>
                      <div className="course-card">
                        ...
                        <div className="course-card-bottom">
                          <Link to={`/course/${course.slug}`} className="btn course-action-btn-white">
                            View Details
                          </Link>
