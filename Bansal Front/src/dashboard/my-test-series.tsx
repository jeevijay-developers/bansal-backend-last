...
import MyTest from "../components/dashboard/MyTest";
...
const Dashboard = () => {
  ...
  const fetchCenters = async () => {
    setLoading(true);
    try {
      const resp = await postApi(APIPATH.myTestSeries, {}, token, logout);
            ...
            <div className="dashboard-card">
               <div className="dashboard-menu-card">
                ...
                >
                  ...
                  <Link to="/dashboard/my-test-series" className="dashboard-menu-link active">
                    <i className="fa-solid fa-book me-2" />
                    My Test Series
                  </Link>
