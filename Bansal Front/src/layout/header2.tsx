                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul className="navbar-nav mx-auto center-header-list">
                                    ...
                                    <li className="nav-item d-block d-lg-none">
                                        <button className="header-cart-btn nav-link-try" type="button" data-bs-toggle="offcanvas" data-bs-target="#CartModal"><img src="/assets/img/carti.svg" alt="#" className="img-fluid" /> Cart(02)</button>
                                    </li>
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="servicesDropdown">
                                            <li><Link className="dropdown-item" to="/?page=test-series">Test Series 1</Link></li>
                                            <li><Link className="dropdown-item" to="/?page=test-series">Test Series 2</Link></li>
                                            <li><Link className="dropdown-item" to="/?page=test-series">Test Series 3</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nav-item dropdown">
                                        <button className="nav-link dropdown-toggle" id="servicesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div className="">
                                <ul className="navbar-nav ms-2 ms-sm-4">
                                    <li className="nav-item d-none d-lg-block">
                                        <button className="header-cart-btn nav-link-try" type="button" data-bs-toggle="offcanvas" data-bs-target="#CartModal"><img src="/assets/img/carti.svg" alt="#" className="img-fluid" /> Cart</button>
                                    </li>
