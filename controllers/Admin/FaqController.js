...
const table_name = "faqs"; // Change this dynamically as needed
const folder_path = "faq"; // Change this dynamically as needed
const module_name = "FAQ"; // Change this dynamically as needed
...
let query = `SELECT * FROM ${table_name} WHERE deleted_at IS NULL ORDER BY id DESC`;
