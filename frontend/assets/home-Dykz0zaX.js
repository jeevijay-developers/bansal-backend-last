...
@media (max-width: 768px) {
  ...
  .coming-soon-text {
    font-size: 1.8rem;
      ...
      `})]}),O={infinite:!1,speed:500,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:1920,settings:{slidesToShow:3}},{breakpoint:1200,settings:{slidesToShow:2}},{breakpoint:768,settings:{slidesToShow:1}}]},B=({coursesFilter:n})=>{const a=n.filter(s=>s.courses&&s.courses.length>0),[l,c]=o.useState("");o.useEffect(()=>{a.length>0&&c(a[0].category_name)},[n]);const t=a.find(s=>s.category_name===l);return e.jsx("section",{className:"overflow-hidden",children:e.jsx("div",{className:"course-listing-section",children:e.jsxs("div",{className:"container",children:[e.jsxs("h2",{className:"heading mb-4",children:["Explore All Our ",e.jsx("span",{className:"course-heading-span",children:"Courses"})]}),e.jsx("ul",{className:"courses-tabs",children:a.map(s=>e.jsx("li",{className:"nav-item",role:"presentation",children:e.jsx("button",{className:`nav-link ${l===s.category_name?"active":""}`,type:"button",onClick:()=>c(s.category_name),children:s.category_name})},s.id))}),e.jsx("div",{className:"courses-listing","data-aos":"fade-left",children:t&&e.jsx("div",{className:"course-listing-slider",children:e.jsx(p,{...O,children:t.courses.map((s,h)=>e.jsx("div",{className:"item",children:e.jsxs("div",{className:"course-card",children:[e.jsxs("div",{className:"course-card-top",style:{display:"flex",flexDirection:"column"},children:[e.jsxs("div",{style:{position:"absolute",top:"10px",left:"10px",backgroundColor:"#ff5722",color:"#fff",padding:"5px 10px",fontSize:"0.8rem",fontWeight:"bold",borderRadius:"4px",zIndex:1,whiteSpace:"nowrap"},children:["Batch: ",s.batch_type||"N/A"," | Class: ",s.class_name||"N/A"]}),e.jsx("img",{src:s.image?`${x}${s.image}`:"/assets/img/no_image.jpg",alt:s.course_name,style:{width:"100%",height:"auto",objectFit:"cover",borderTopLeftRadius:"8px",borderTopRightRadius:"8px"}}),e.jsxs("div",{className:"course-top-content",children:[e.jsxs("span",{className:"course-badge",children:[e.jsx("i",{className:"fa-solid fa-video"})," ",s==null?void 0:s.batch_type]}),e.jsx("h3",{className:"course-heading",children:s.course_name}),e.jsx("p",{className:"course-title-heading",children:s==null?void 0:s.title_heading}),e.jsxs("p",{className:"course-price",children:["₹",s.offer_price,e.jsxs("span",{className:"mrp-price",children:["₹",s.price]}),s.discount_type==="price"?e.jsxs("span",{className:"discount-price",children:["₹ ",s.discount," OFF"]}):e.jsxs("span",{className:"discount-price",children:[s.discount,"% OFF"]})]})]})]}),e.jsx("div",{className:"course-card-bottom",children:e.jsx(d,{to:`/course/${s.slug}`,className:"btn course-action-btn-white",children:"View Details"})})]})},h))})})})]})})})},I={infinite:!1,speed:500,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:1920,settings:{slidesToShow:3}},{breakpoint:1200,settings:{slidesToShow:2}},{breakpoint:768,settings:{slidesToShow:1}}]},R=({coursesFilter:n})=>{const a=n.filter(s=>s.test_series&&s.test_series.length>0),[l,c]=o.useState("");o.useEffect(()=>{a.length>0&&c(a[0].category_name)},[n]);const t=a.find(s=>s.category_name===l);return a.length===0?null:e.jsx("section",{className:"overflow-hidden",children:e.jsx("div",{className:"course-listing-section bg-white",children:e.jsxs("div",{className:"container",children:[e.jsxs("h2",{className:"heading mb-4",children:["Explore All Our"," ",e.jsx("span",{className:"course-heading-span",children:"Test Series"})]}),e.jsx("ul",{className:"courses-tabs mb-0",children:a.map(s=>e.jsx("li",{className:"nav-item",role:"presentation",children:e.jsx("button",{className:`nav-link ${l===s.category_name?"active":""}`,type:"button",onClick:()=>c(s.category_name),children:s.category_name})},s.id))}),e.jsx("div",{className:"courses-listing","data-aos":"fade-left",children:t&&e.jsx("div",{className:"course-listing-slider",children:e.jsx(p,{...I,children:t.test_series.map((s,h)=>e.jsx("div",{className:"item",children:e.jsxs("div",{className:"course-card",children:[e.jsxs("div",{className:"course-card-top",children:[e.jsx("div",{className:"course-op-icon",children:e.jsx("i",{className:"fa-solid fa-book"})}),e.jsxs("div",{className:"course-top-content",children:[e.jsxs("span",{className:"course-badge",children:[e.jsx("i",{className:"fa-solid fa-video"})," ",s==null?void 0:s.batch_type]}),e.jsxs("h3",{className:"course-heading",children:[s.name,s.discount_type]}),e.jsx("p",{children:s.title_heading}),e.jsxs("p",{className:"course-price",children:["₹",s.offer_price,e.jsxs("span",{className:"mrp-price",children:["₹",s.price]}),s.discount_type==="price"?e.jsxs("span",{className:"discount-price",children:["₹",s.discount," OFF"]}):e.jsxs("span",{className:"discount-price",children:[s.discount,"% OFF"]})]})]})]}),e.jsx("div",{className:"course-card-bottom",children:e.jsx(d,{to:`/test-series/${s.slug}`,className:"btn course-action-btn-white",children:"View Details"})})]})},h))})})})]})})})},q="https://bansal.ac.in/assets/Crop-Video-CK6hUvkB.mp4",y={dots:!1,arrows:!0,infinite:!0,speed:500,slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1500,nextArrow:e.jsx("button",{type:"button",className:"slick-next",style:{background:"none",border:"none",position:"absolute",top:"50%",right:"10px",zIndex:1,fontSize:"24px",color:"#000",transform:"translateY(-50%)",cursor:"pointer"},children:e.jsx("i",{className:"fas fa-chevron-right"})}),prevArrow:e.jsx("button",{type:"button",className:"slick-prev",style:{background:"none",border:"none",position:"absolute",top:"50%",left:"10px",zIndex:1,fontSize:"24px",color:"#000",transform:"translateY(-50%)",cursor:"pointer"},children:e.jsx("i",{className:"fas fa-chevron-left"})})},V=()=>{var u,N,f,v,b,w;const n=o.useRef(null),{token:a,logout:l}=T(),[c,t]=o.useState(!1),[s,h]=o.useState("");o.useEffect(()=>{_.init(),k();const i=m.current,r=n.current},[]),o.useEffect(()=>{const i=()=>{const r=document.querySelectorAll(".h-100-equal");let g=0;r.forEach(j=>{j.style.height="auto",g=Math.max(g,j.offsetHeight)}),r.forEach(j=>{j.style.height=`${g}px`})};return setTimeout(i,100),window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]);const k=()=>{t(!0),E(F.home,{},a,l).then(i=>{const{data:r}=i;h(r)}).catch(i=>console.log(i)).finally(()=>{t(!1)})},m=o.useRef(null),S=()=>{m.current&&(m.current.paused?m.current.play():m.current.pause())};return e.jsxs(e.Fragment,{children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
